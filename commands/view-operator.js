    ...
    try {
        ...
        const embed = new Discord.EmbedBuilder()
            ...
            .addFields({
                ...
                name: 'Real name',
                value: operator.bio.realname,
                inline: true
            }, {
                name: 'Organisation',
                value: operator.bio.org,
                inline: true
            }, {
                name: 'Squad',
                value: operator.bio.squad,
                inline: true
            }, {
                name: 'Season release',
                value: operator.season,
                inline: true
            }, {
                name: 'Height (in meters)',
                value: operator.bio.height,
                inline: true
            }, {
                name: 'Weight (in kilograms)',
                value: operator.bio.weight,
                inline: true
            }, {
                name: 'Date of birth',
                value: operator.bio.dateofbirth,
                inline: true
            }, {
                name: 'Place of birth',
                value: operator.bio.placeofbirth,
                inline: true
            })
